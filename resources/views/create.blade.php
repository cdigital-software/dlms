...
<div class="container mt-4">
    ...
    <div class="card " style="margin-top: -150px;box-shadow:5px 10px 5px #E12836">
        <div class="card-header text-left font-weight-bold" >
            <b>Add new License Data</b>
        </div>

        <div class="card-body" >
            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('store')}}" autocomplete="off">
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="check" style="margin-top:0px;">
                                <input class="effect-9" type="text"name="name" class="form-control" required="">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="check" style="margin-top:0px">
                                ...
                                <input class="effect-9"  type="text" name="father_name" class="form-control" required="">
                                <span class="focus-border">
                                    <i></i>
                                    </span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="check" style="margin-top:0px">
                                ...
                                <input class="effect-9"  type="text" name="license_no" class="form-control" required="">
                                <span class="focus-border">
                                    <i></i>
                                    </span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="check" style="margin-top:0px">
                                ...
                                <input class="effect-9"  type="date" style="width:100%"name="issue_date" class="form-control" required="">
                                <span class="focus-border">
                                    <i></i>
                                    </span>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="check" style="margin-top:0px">
                                ...
                                <input class="effect-9" style="width:100%" type="date" name="exp_date" class="form-control" required="">
                                <span class="focus-border">
                                    <i></i>
                                    </span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="" style="margin-left:12px"><b>Address </b> </label>
                            <div class="check" style="margin-top:0px">

                                <input class="effect-9"  type="text" name="address" class="form-control" required="">
                                <span class="focus-border">
                                    <i></i>
                                    </span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="" style="margin-left:12px"><b>Other info</b> </label>
                            <div class="check" style="margin-top:0px">

                                <input class="effect-9"  type="text" name="other_info" class="form-control" required="">
                                <span class="focus-border">
                                    <i></i>
                                    </span>
                            </div>
                ...
                <button type="submit" class="btn"
                        style="color:white;background-color:#E12836;"><b>Submit</b></button>
            </form>
        </div>
    </div>
</div>
